...
type TabType = 'overview' | 'api-keys' | 'webhook' | 'analytics' | 'article-generator' | 'settings';
...
export const Dashboard: React.FC = () => {
  ...
  const navigation = [
    ...
    { id: 'article-generator', name: 'Article Generator', icon: FileText },
      ...
      `}>
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <span className="ml-3 font-bold text-gray-900">Contact Extractor</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 lg:hidden">
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 font-bold text-gray-900">Contact Extractor</span>
            </div>
