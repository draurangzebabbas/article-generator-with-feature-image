    ...
    try {
        ...
        const branchB = (async () => {
            ...
            const section1GeneratorMessages = [
                {
                    role: "system",
                    content: "You are an expert SEO content writer. Your task is to write the full article body using the provided headings list. \\r\\n\\r\\n---\\r\\n\\r\\n### You Will Receive:\\r\\n\\r\\n- **title**: The post title (for internal reference only).\\r\\n- **excerpt**: A short introductory paragraph to rewrite.\\r\\n- **related_keywords**: Additional keywords to include.\\r\\n- **section_1**: A list of headings strings indicating their hierarchy (e.g. 'H2: Title', 'H3: Subtitle').\\r\\n\\r\\n---\\r\\n\\r\\n### Output Rules:\\r\\n- Write **in full HTML**, using only `<p>`, `<ul>`, `<li>`, `<strong>`, `<em>`, `<a>`, `<blockquote>`, `<code>`, `<br>`,`<h1>`, `<h2>`, `<h3>`, `<h4>`.\\r\\n- Start with a `<p>` tag that **rewrites and enriches the excerpt**.\\r\\n- **HEADING HANDLING**: The input headings will start with 'H2:', 'H3:', or 'H4:'. You MUST use the corresponding HTML tag for each (<h2>, <h3>, or <h4>) and **remove the prefix** from the visible text.\\r\\n  - Input: \"H2: Usage\" -> Output: `<h2>Usage</h2>`\\r\\n  - Input: \"H3: Step 1\" -> Output: `<h3>Step 1</h3>`\\r\\n- Follow the input structure exactly. Do not skip or reorder headings.\\r\\n- Write detailed, clear, and educational content for each section tailored to its level.\\r\\n- Paragraphs should be short (3–5 sentences).\\r\\n- Use bullet points (`<ul><li>`) where appropriate.\\r\\n- Use the **main keyword** naturally and frequently.\\r\\n- **Length**: Aim for substantial depth.\\r\\n\\r\\n---\\r\\n\\r\\n### Final Output Format:\\r\\n- Output the article in clean HTML.\\r\\n- Begin with intro `<p>`.\\r\\n- Then write each section with its correct `h` tag and content.\\r\\nwith no wrapper, title, FAQ, or extra punctuation or markdown.\\n​"
                },
                {
                    role: "user",
            ...
            const section2GeneratorMessages = [
                {
                    role: "system",
                    content: "You are a professional SEO copywriter. Your task is to generate the second section of content based on the given headings list, which includes structure prefixes (H2, H3, H4).\\n\\n### Key Requirements:\\n\\n1. **Heading Structure**\\n   - The input `section_2` contains strings like 'H2: Topic', 'H3: Subtopic'.\\n   - You MUST convert these to actual HTML tags: `<h2>Topic</h2>`, `<h3>Subtopic</h3>`.\\n   - **Remove the prefix** (H2:, H3:) from the final visible heading text.\\n\\n2. **Content Generation**\\n   - Write detailed, engaging content for each heading.\\n   - H2 sections should be comprehensive (2-3 paragraphs).\\n   - H3/H4 sections can be concise but informative.\\n   - Use natural language, examples, and tips.\\n\\n3. **SEO Optimization**\\n   - Incorporate the main keyword and related keywords naturally.\\n   - Ensure content answers user search intent.\\n\\n### Output Format:\\nReturn the complete section content as HTML. Do not include the main title or any other sections.\\n\\n### Example Structure:\\n```html\\n<h2>Heading 1</h2>\\n<p>Content...</p>\\n\\n<h3>Subheading A</h3>\\n<p>Content...</p>\\n```\\n\\nReturn only the HTML content, no markdown."
                },
                {
                    role: "user",
                    content: `Main Keyword: "${sanitizedMainKeyword}"\\n\\nSection 2 Headings:\\n${metaData.headings?.section_2?.join('\\n') || 'No section 2 headings'}\\n\\nRelated Keywords: ${relatedKeywordsString}\\n\\nGenerate detailed content for each heading in section 2, respecting the H2/H3/H4 prefixes.`
                }
            ];
